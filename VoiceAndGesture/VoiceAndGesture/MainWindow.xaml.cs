namespace Microsoft.Samples.Kinect.SpeechBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        public bool[] followSpeech = new bool[2];
        ...
        private void SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            ...
            {
                var ahmed = e.Result.Semantics.Value.ToString();
                ahmed.Trim();
                Console.WriteLine(ahmed);
                if (e.Result.Semantics.Value.ToString() == "FOLLOW MAX")
                    followSpeech[0] = true;
                else if (e.Result.Semantics.Value.ToString() == "FOLLOW PINGO")
                    followSpeech[1] = true;
                else
                {
                    for (int i = 0; i < followSpeech.Length; i++)
                        followSpeech[i] = false;
                }
            }
        }
